    ...
    <View>
      <ScrollView>
        <View style={{ padding: 10, width: '100%', backgroundColor: '#000', height: 150 }}>
          <TouchableOpacity>
            <Image source={require('../../assets/adaptive-icon.png')}             //../assets/adaptive-icon.png
        ...
        <View style={AppStyle.StyleProfile.items}>
          <FontAwesome5 name="orders" size={20} color="black" style={{marginRight: 10}}/>
          <Text>{userInfo.others.orders.length}</Text>
